package com.backend.lab.api.admin.todayNews.facade;
...
public class AdminTodayNewsFacade {
  ...
  @Transactional
  public void create(Long adminId, TodayNewsDTO req) {
    Admin admin = adminService.getById(adminId);
    todayNewsService.create(req, admin);
  }

  @Transactional
  public void update(Long postId, TodayNewsDTO req) {
    todayNewsService.update(postId, req);
  }

  @Transactional
  public void delete(Long id) {
    todayNewsService.delete(id);
  }
