...
public class Jwt {
  ...
  private String sign(Claims claims, int expireTime) {
    ...
    return JWT.create()
        ...
        .withClaim("userType", claims.userType.name())
        .sign(algorithm);
  }
  ...
  public static class Claims {
    ...
    Claims(DecodedJWT decodedJwt) {
      ...
      Claim userType = decodedJwt.getClaim("userType");
      if (!userType.isNull()) {
        this.userType = UserType.valueOf(userType.asString());
      }
    ...
    public static Claims from(Long memberId, String[] roles, UserType userType) {
