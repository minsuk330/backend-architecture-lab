...
@AllArgsConstructor
@SQLRestriction("deleted_at IS NOT NULL AND delete_persistent_at IS NULL")
@SQLDelete(sql = "UPDATE admin SET delete_persistent_at = NOW() WHERE id = ?")
public class DeletedAdmin extends BaseEntity implements AuthenticateUser {
