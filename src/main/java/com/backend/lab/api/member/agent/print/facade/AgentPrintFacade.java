package com.backend.lab.api.member.agent.print.facade;
...
public class AgentPrintFacade {

  private final PrintService printService;
  private final UploadFileService uploadFileService;

  @Transactional
  public PrintResp get(Long agentId) {
    Print print = printService.ensureAgentPrintExist(agentId);
    return this.printResp(print);
  }


  @Transactional
  public void imageUpdate(PrintUpdateReq req,Long agentId) {
    ...
    printService.updateImages(req, PrintType.AGENT,agentId);
  }

  @Transactional
  public void titleUpdate(PrintUpdateReq req, Long agentId) {
    printService.updateLastTitle(req, PrintType.AGENT,agentId);
  }
